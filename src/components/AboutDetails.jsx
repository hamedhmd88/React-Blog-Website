    ...
    <div className="container mx-auto p-4">
         ...
         <div>
           ...
           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
             {[
               { name: ' Adrio Devid', title: 'Operations manager', image: '/src/assets/user-01.png' },
               { name: ' Rayna Mario', title: 'The editor', image: '/src/assets/user-02.png' },
               { name: 'David Tac ', title: 'Head of Publications ', image: '/src/assets/user-03.png' },
               { name: ' Mark Jacob', title: ' Head of Marketing', image: '/src/assets/user-01.png' }
             ].map((author, index) => (
